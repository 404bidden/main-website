...
export function StatsSection() {
    ...
    const [counters, setCounters] = useState({ users: 0, uptime: 0, checks: 0, response: 0 });
            ...
            <div className="container px-4 relative z-10">
                <div className="text-center mb-14">
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold tracking-tighter mb-4">
                        The Numbers <span className="text-primary">Speak</span> for Themselves
                    </h2>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {stats.map((stat, index) => (
                        <div
                            key={index}
                            className={`group relative bg-card/40 backdrop-blur-sm border border-border rounded-lg p-6 transition-all duration-700 ease-in-out hover:shadow-lg hover:shadow-primary/5 ${isVisible
